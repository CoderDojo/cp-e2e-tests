...
browser.addCommand('selectDate', function (name, date) {
  ...
  var text = browser.getText(baseXPath + '/following-sibling::div[@uib-datepicker-popup-wrap]//table[contains(@class, "uib-yearpicker")]//button[contains(@class, "uib-title")]/strong')
  ...
  if (date.getFullYear() < yearsRange[0]) {
    ...
    for (var i = 0; i < numOfPagesBack; i++) {
      browser.click(baseXPath + '/following-sibling::div[@uib-datepicker-popup-wrap]//table[contains(@class, "uib-yearpicker")]//button[contains(@class, "uib-left")]');
    }
    ...
    for (var i = 0; i < numOfPagesForward; i++) {
      browser.click(baseXPath + '/following-sibling::div[@uib-datepicker-popup-wrap]//table[contains(@class, "uib-yearpicker")]//button[contains(@class, "uib-right")]');
    }
  }
